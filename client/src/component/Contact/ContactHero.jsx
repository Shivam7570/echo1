...
export default function ContactHero() {
    ...
    // Submit Handler for Site Visit
    const handleFormSubmit = (e) => {
        e.preventDefault();
        alert(`Thank you ${formData.fullName}! Your site visit request has been received.`);
    ...
    const handleDownloadBrochure = () => {
        // Replace with the path to your actual brochure PDF asset
    ...
    return (
        <div className="relative min-h-screen w-full bg-stone-950 text-white font-sans overflow-hidden flex flex-col justify-center">
            ...
            <div
                ...
                style={{
                    backgroundImage: `linear-gradient(to right, rgba(0,0,0,0.85) 0%, rgba(0,0,0,0.4) 50%, rgba(0,0,0,0.6) 100%), linear-gradient(to top, rgba(0,0,0,0.8) 0%, transparent 40%), url('/src/assets/ContactHeroImg.png')`
                }}
            />
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fadeIn">
                    <div className="bg-[#181816] border border-[#D4A359]/30 rounded-2xl w-full max-w-lg p-6 md:p-8 relative shadow-2xl text-stone-100">
                        ...
                        <div className="text-center mb-6 space-y-1">
                            <p className="font-serif italic text-amber-400 text-sm">Schedule Your Experience</p>
                        ...
                        <form onSubmit={handleFormSubmit} className="space-y-3.5">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <div className="relative">
                                    <Phone className="w-4 h-4 absolute left-3 top-3 text-amber-400/80" />
                                    <input
                                        type="tel"
                                        name="phone"
                                        required
                                ...
                                <div className="relative">
                                    <MapPin className="w-4 h-4 absolute left-3 top-3 text-amber-400/80" />
                                    <input
                                        type="text"
                                        name="city"
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <div className="relative">
                                    <Building2 className="w-4 h-4 absolute left-3 top-3 text-amber-400/80" />
                                    <select
                                        name="resortType"
                                    ...
                                    >
                                        ...
                                        <option value="Type 4">Resort Type 4</option>
                                        <option value="Type 5">Resort Type 5</option>
                                    </select>
                                </div>

                                <div className="relative">
                                    <Calendar className="w-4 h-4 absolute left-3 top-3 text-amber-400/80" />
                                    <input
                                        type="date"
                                        name="preferredDate"
